...
- `importance` (int): 1-10 scale
  - 9-10: Architectural decisions, foundational patterns
  - 8-9: Important decisions with clear rationale
  - 7-8: Technical patterns, non-trivial solutions
  - 6-7: Project milestones, specific implementations
  - <6: Routine information (use sparingly)
...
- `project_type` (str): One of the following values:
  - `personal` - Personal projects and experiments
  - `work` - Work-related projects
  - `learning` - Educational or learning projects
  - `development` - Active software development (most common for code repos)
  - `infrastructure` - DevOps, CI/CD, deployment configs
  - `template` - Boilerplate/starter templates
  - `product` - Commercial products or SaaS
  - `marketing` - Marketing websites, landing pages
  - `finance` - Financial tools or dashboards
  - `documentation` - Documentation-focused repos
  - `development-environment` - Dev environment configs (dotfiles, IDE settings)
  - `third-party-library` - External libraries being tracked
  - `open-source` - Open-source contributions (external OSS projects)
